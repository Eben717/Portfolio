    ...
    const sampleProjects: InsertProject[] = [
      {
        ...
        description:
          "A comprehensive dashboard for e-commerce management with real-time analytics, inventory tracking, and sales reporting.",
        image:
      ...
      },
      {
        ...
        description:
          "A productivity app for task management with team collaboration features, offline support, and intuitive drag-and-drop interface.",
        image:
      ...
      },
      {
        ...
        description:
          "A social networking platform with real-time messaging, content sharing, and advanced privacy controls for professional communities.",
        image:
      ...
      },
      {
        ...
        description:
          "An advanced weather application with interactive maps, historical data analysis, and AI-powered predictions for agricultural planning.",
        image:
          "https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=500",
      ...
      },
      {
        ...
        description:
          "A stunning portfolio website for a creative designer featuring smooth animations, interactive galleries, and optimized performance.",
        image:
      ...
      },
      {
        ...
        description:
          "A comprehensive fitness tracking application with workout planning, progress monitoring, and social features for motivation.",
        image:
